...
"x86_64-linux-3.10.0-957.5.1.el7.x86_64" or
	die "Errno architecture (x86_64-linux-3.10.0-957.5.1.el7.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
