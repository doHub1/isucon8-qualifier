...
XS_EUPXS(XS_Text__Xslate__Type__Pair_CLONE)
{
    ...
    {
#line 529 "src/xslate_methods.xs"
{
    MY_CXT_CLONE;
    MY_CXT.pair_stash = gv_stashpvs(TX_PAIR_CLASS, GV_ADDMULTI);
    PERL_UNUSED_VAR(items);
}
#line 685 "src/xslate_methods.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 543 "src/xslate_methods.xs"
{
    ST(0) = *av_fetch(pair, ix, TRUE);
}
#line 719 "src/xslate_methods.c"
    }
    XSRETURN(1);
}
...
#line 519 "src/xslate_methods.xs"
{
    MY_CXT_INIT;
    MY_CXT.pair_stash = gv_stashpvs(TX_PAIR_CLASS, GV_ADDMULTI);
}
