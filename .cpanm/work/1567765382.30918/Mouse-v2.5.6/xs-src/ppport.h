...
----------------------------------------------------------------------
    ...
    xs-src/ppport.h -- Perl/Pollution/Portability Version 3.42
...
F<xs-src/ppport.h> and below which version of Perl they probably
 ...
 */
#if PERL_REVISION != 5
#  error xs-src/ppport.h only works with Perl version 5
